...
#define BUTTON_RUP		0x00010000l	// 方向キー上(.IY<0)
#define BUTTON_RDOWN	0x00020000l	// 方向キー下(.IY>0)
#define BUTTON_RLEFT	0x00040000l	// 方向キー左(.IX<0)
#define BUTTON_RRIGHT	0x00080000l	// 方向キー右(.IX>0)

//#define BUTTON_UE		0x00004000l //十字キー
//#define BUTTON_SHITA	0x00004002l //十字キー
//#define BUTTON_MIGI	0x00004004l //十字キー
//#define BUTTON_HIDARI	0x00004008l //十字キー
